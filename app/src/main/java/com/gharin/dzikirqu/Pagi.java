...
public class Pagi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvMainPagipetang= findViewById(R.id.rvMainPagi);
    ...
    private void setDataPagi () {
            int count = 0;
            for (String id : tvNoPagi) {
                arrayList.add(new ModelDzikir(id, tvArabPagi[count], tvArtiPagi[count]));
                count++;
