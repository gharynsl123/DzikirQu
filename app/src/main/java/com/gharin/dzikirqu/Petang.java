...
public class Petang extends AppCompatActivity {
    ...
    private String[] tvArabPetang = {
            ...
            "اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي الدُّنْيَا وَاْلآخِرَةِ، اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي دِيْنِيْ وَدُنْيَايَ وَأَهْلِيْ وَمَالِيْ اللَّهُمَّ اسْتُرْ عَوْرَاتِى وَآمِنْ رَوْعَاتِى. اَللَّهُمَّ احْفَظْنِيْ مِنْ بَيْنِ يَدَيَّ، وَمِنْ خَلْفِيْ، وَعَنْ يَمِيْنِيْ وَعَنْ شِمَالِيْ، وَمِنْ فَوْقِيْ، وَأَعُوْذُ بِعَظَمَتِكَ أَنْ أُغْتَالَ مِنْ تَحْتِيَْ",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Dzikir Petang");
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        rvMainPagipetang= findViewById(R.id.rvMainPetang);
        arrayList = new ArrayList<>();
        adapterDzikir = new AdapterDzikir(arrayList);
        setDataPentang();
        rvMainPagipetang.setAdapter(adapterDzikir);
        rvMainPagipetang.setLayoutManager(new LinearLayoutManager(this));
    }

    private void setDataPentang() {
        int count = 0;
        for (String id : tvNoPetang) {
            arrayList.add(new ModelDzikir(id, tvArabPetang[count], tvArtiPetang[count]));
            count++;
